...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _addTask() {
    ...
    _databaseService.addTask(
        _name!, _type!, _age!, _breed!, _photoPath!, _weight!, _healthStatus!);
    setState(() {
      _name = null;
      _type = null;
      _age = null;
              ...
              child: Column(
                ...
                children: [
                  TextField(
                    ...
                    maxLength: 21, // Limit the length of the input
                  ),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(16)),
                        hintText: 'Evcil Hayvan Ağırlığı (kg)',
